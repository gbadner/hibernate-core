...
public class CascadingActions {
	...
	public static final CascadingAction LOCK = new BaseCascadingAction() {
		...
		public void cascade(
			...
			// don't bother checking if lock operation is in progress
			// since we're in the middle of a lock operation.
			final LockOperationContext lockOperationContext =
					session.getOperationContext( OperationContextType.LOCK);
	...
	public static final CascadingAction REFRESH = new BaseCascadingAction() {
		...
		public void cascade(
			...
			session.refresh( entityName, child );
		}
	...
	public static final CascadingAction MERGE = new BaseCascadingAction() {
		...
		public void cascade(
			...
			session.merge( entityName, child );
		}
	...
	public static final CascadingAction PERSIST_ON_FLUSH = new BaseCascadingAction() {
		...
		public void cascade(
			...
			session.persistOnFlush( entityName, child );
		}
	...
	public static final CascadingAction REPLICATE = new BaseCascadingAction() {
		...
		public void cascade(
			...
			session.replicate(
					entityName,
					child,
					session.getOperationContext( OperationContextType.REPLICATE ).getReplicationMode()
			);
		}
