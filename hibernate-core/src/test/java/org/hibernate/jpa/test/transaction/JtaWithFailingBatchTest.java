...
public class JtaWithFailingBatchTest extends BaseEntityManagerFunctionalTestCase {
	...
	public void testPersist() {
		...
		try {
			...
			assertThat( calledReleaseStatements, is( false ) );
	...
	private static boolean calledReleaseStatements = false;
