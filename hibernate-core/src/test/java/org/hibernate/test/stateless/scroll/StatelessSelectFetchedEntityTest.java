 ...
 * @author Gail Badner
 */
@TestForIssue( jiraKey = "HHH-13404" )
public class StatelessSelectFetchedEntityTest extends BaseCoreFunctionalTestCase {
/*
	@Test
	@TestForIssue( jiraKey = "HHH-13404" )
	//@FailureExpected( jiraKey = "HHH-13404" )
	...
	public void testDistinctScrollInStatelessSession() {
		...
		final String hql = "Select distinct a from AEntity a";
	...
	public static class CEntity {
		...
		@ManyToOne(fetch= FetchType.EAGER, cascade = CascadeType.ALL)
		@Fetch(FetchMode.SELECT)
		protected AEntity aEntity = null;
